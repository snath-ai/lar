...
For the canonical reference implementation showing all 12 compliance primitives firing in sequence, see: **[EU AI Act Finance Showcase →](https://docs.snath.ai/compliance/finance-showcase/)**
